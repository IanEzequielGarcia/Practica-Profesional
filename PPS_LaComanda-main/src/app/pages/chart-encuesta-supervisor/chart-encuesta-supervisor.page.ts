...
@Component({
  selector: 'app-chart-encuesta-supervisor',
  templateUrl: './chart-encuesta-supervisor.page.html',
  styleUrls: ['./chart-encuesta-supervisor.page.scss'],
})
export class ChartEncuestaSupervisorPage implements OnInit {
