...
export class PushService {
  ...
  constructor(public fs: FirestoreService, private authS: AuthService, private router: Router,private platform: Platform, 
    private firestore: Firestore, private http: HttpClient) {
