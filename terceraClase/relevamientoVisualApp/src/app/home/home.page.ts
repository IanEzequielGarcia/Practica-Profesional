...
export class HomePage implements OnInit{
  ...
  //cargando=false;
  loginForm: FormGroup;
  constructor(public auth: AuthService,private modalController: ModalController,public fb: FormBuilder,public navCtrl: NavController) {
    this.presentSplash();
  }
  ngOnInit(): void {
  ...
  enviar(){
    const r=this.loginForm.getRawValue();
      this.auth.login(r.email,r.contrasena).then((a)=>{
